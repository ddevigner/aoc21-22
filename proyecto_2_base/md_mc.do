...
add wave -noupdate -expand -group MC -group MC_Storage -expand -group Via_0 -label hit_0 /testbench_md_mas_mc/uut/MC/Via_0/hit
add wave -noupdate -expand -group MC -group MC_Storage -expand -group Via_0 -label Via_0_Dout /testbench_md_mas_mc/uut/MC/Via_0/Dout
add wave -noupdate -expand -group MC -group MC_Storage -expand -group Via_0 -label Via_0_tags -expand /testbench_md_mas_mc/uut/MC/Via_0/MC_Tags
add wave -noupdate -expand -group MC -group MC_Storage -expand -group Via_0 -label Via_0_data -expand /testbench_md_mas_mc/uut/MC/Via_0/MC_data
add wave -noupdate -expand -group MC -group MC_Storage -group Via_1 -label hit_1 /testbench_md_mas_mc/uut/MC/Via_1/hit
add wave -noupdate -expand -group MC -group MC_Storage -group Via_1 -label Via_1_Dout /testbench_md_mas_mc/uut/MC/Via_1/Dout
add wave -noupdate -expand -group MC -group MC_Storage -group Via_1 -label Via_1_tags /testbench_md_mas_mc/uut/MC/Via_1/MC_Tags
add wave -noupdate -expand -group MC -group MC_Storage -group Via_1 -label Via_1_data -expand /testbench_md_mas_mc/uut/MC/Via_1/MC_data
...
add wave -noupdate -label MD_Scratch_RAM /testbench_md_mas_mc/uut/M_scratch/MD_scratch/RAM
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {257072 ps} 0}
...
update
WaveRestoreZoom {0 ps} {126727 ps}
