...
;   (08220000) LW R2, 0(R1)   ;   F D D E M W
;   (0843ffec) LW R3, -20(R2) ;     F F D D E M W
;   (0804000c) LW R4, 12(R0)  ;         F F D E M W
;   (04852800) ADD R5, R4, R5 ;             F D D E M W
;   (0c05000c) SW R5, 12(R0)  ;               F F D E M W
;   (04010000) ADD R0, R0, R1 ;                   F D E M W
;   (10030001) BEQ R0, R3, 40 ;                     F D D D E M W
;   - Si salto no tomado:     ;                       ↓   
;   (1000fffa) BEQ R0, R0, 12 ;                       F F F D E M W                    
;   (04452800) ADD R5, R2, R5 ;                       |     F ↓ - - - -
;   (0804000c) LW R4, 12(R0) (Sig. Iter.)             |       F F D E M W
;   ...                       ;                       |           . . .
;   - Si salto tomado:        ;                       ↓
;   (1000fffa) BEQ R0, R0, 12 ;                       F F F ↓ - - - -
...
loop:
    ...
    BEQ R0, R3, 36  ; Si (R0 == 16) Salto a store.
    BEQ R0, R0, 12  ; Salto a loop.
store:
